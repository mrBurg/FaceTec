const AppUtilities = (function () {
  var vocalGuidanceSoundFilesDirectory = '/facetec/audio/';
  ...
  function setVocalGuidanceMode() {
    ...
    switch (vocalGuidanceMode) {
      case VocalGuidanceMode.OFF:
        ...
        document.getElementById('vocal-guidance-icon-minimal').style.display =
          'block';
        document.getElementById('vocal-guidance-icon-full').style.display =
          'none';
        document.getElementById('vocal-guidance-icon-off').style.display =
          'none';
  ...
  function formatUIForDevice() {
    if (isLikelyMobileDevice()) {
      ...
      document.getElementById('main-interface').style.backgroundColor =
        'transparent';
      ...
      document
        .getElementById('vocal-icon-container')
        .parentNode.parentNode.parentNode.parentNode.insertBefore(
          document.getElementById('vocal-icon-container'),
          document.getElementById('vocal-icon-container').parentNode.parentNode
