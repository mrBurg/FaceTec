var AdditionalScreens = /** @class */ (function () {
  ...
  AdditionalScreens.setServerUpgradeStyling = function (
    elementToCopyStylesFrom,
    functionToCallOnExitFromAdditionalScreen
  ) {
    ...
    document.getElementById('additional-screen-button').onclick =
      functionToCallOnExitFromAdditionalScreen;
  };
  // Fade out the main UI and show the Server Upgrade view
  AdditionalScreens.showServerUpGradeView = function () {
    var ServerUpgradeLogo = '/facetec/images/upgrade.png';
