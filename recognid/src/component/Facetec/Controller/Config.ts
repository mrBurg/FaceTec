...
import {
  configPropsType,
  initializeFromAutogeneratedConfigCallbackType,
} from './@types';
...
export class Config {
  ...
  currentLowLightCustomization: jsonType;
  currentDynamicDimmingCustomization: jsonType;
  ...
  initializeFromAutogeneratedConfig(
    sdk: facetecSdkType,
    callback: initializeFromAutogeneratedConfigCallbackType
  ) {
  ...
  retrieveConfigurationWizardCustomization(sdk: facetecSdkType) {
  ...
  retrieveLowLightConfigurationWizardCustomization(sdk: facetecSdkType) {
  ...
  retrieveDynamicDimmingConfigurationWizardCustomization(sdk: facetecSdkType) {
    const defaultCustomization =
      this.retrieveConfigurationWizardCustomization(sdk);
